...
class AgronegocioPresentationPageOld extends StatelessWidget {

  final int? agronegocioId;

  AgronegocioPresentationPageOld({super.key, this.agronegocioId});
...
class CarouselDemoHome extends StatelessWidget {
  CarouselDemoHome({super.key});
  final themeMode = ValueNotifier(2);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Carousel demoxxxxxxxxxxxxxxxxxxxxxxx'),
        actions: [
          IconButton(
